...
from utils.plots import ensemble_plot_final_K, scatter_plot, plot_bootstraps, plot_bootstraps_for_dataset
...
# pairs_metrics_multi_grid_all(method_names=method_names, data_np=data_np, experiment_name=experiment_name, dataset_paths=dataset_paths, metrics=metrics_alias, filename="ex12_wilcoxon_all", ref_methods=["Margin_Diversity_Classifier_B100", "Hellinger_Gmean_Classifier_B100"], offset=-10)
...
# plot_bootstraps(mean_scores=mean_scores, metrics_alias=metrics_alias, max_bootstraps_list=max_bootstraps_list, experiment_name=experiment_name)
...
# plot_bootstraps_for_dataset(mean_scores=mean_scores, stds=stds, metrics_alias=metrics_alias, max_bootstraps_list=max_bootstraps_list, experiment_name=experiment_name, datasets=dataset_names)
